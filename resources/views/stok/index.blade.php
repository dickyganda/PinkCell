             ...
             <a href="" class="btn btn-success btn-xs" title="Tambah Data Baru" role="button" data-toggle="modal" data-target="#modaltambahdata"><i class="fas fa-plus-circle"></i></a><br><br>
              ...
              <table id="dt-basic-example" class="table table-bordered table-responsive table-hover table-striped">
                                                ...
                                                @foreach($stok as $stok)
                                                    <tr>
                                                        <td>{{ $i++ }}</td>
                                                        {{-- <td>{{ $carbon::parse($stok->TglMasuk)->format('d/m/Y H:i:s') }}</td> --}}
                                                        <td>{{ $stok->ImeiStok}}</td>
                                                        <td>{{ $stok->MerkStok }}</td>
                                                        <td>{{ $stok->TypeStok }}</td>
                                                        <td>{{ $stok->RamStok.'/'.$stok->RomStok }}</td>
                                                        <td>@currency( $stok->HargaNet )</td>
                                                        <td>
                                                          <a href="/stok/edit/{{ $stok->IdStok }}" title="Edit"
                                                          class="btn btn-warning btn-xs" role="button"><i class="fas fa-pen"></i>
                                                          Edit</a>
                                                        
                                                          <a href="/stok/sold/{{ $stok->IdStok }}" title="Edit"
                                                            class="btn btn-warning btn-xs" role="button"><i class="fas fa-pen"></i>
                                                            Sold</a>
                                                        </td>
                                                    </tr>
